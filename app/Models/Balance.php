...
class Balance extends Model
{
    ...
    public function withdraw(float $value) : Array{
        ...
        //verifica se o saldo é menor que o valor que prente retirar
            //valor da coluna amount da tabela balances do usuário autenticado
        ...
        //variavel para receber o valor antes do deposito
            //primeiro verifica se a variavel é null, caso for altera para 0, pois 
                //historico total_before não aceita valor null
        $totalBefore = $this->amount ? $this->amount : 0;
        //atualiza valor do saldo (realiza o saque)
        $this->amount -= number_format($value, 2, '.', '');
        //salva valor no BD
        $withdraw = $this->save();
