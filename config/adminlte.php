...
return [
    ...
    */
    ...
    //Texto na parte superior direita da página
    'logo' => '<b>Curso</b>L5.5',

    //Texto na parte superior direita da página (mobile)
    'logo_mini' => '<b>L</b>5.5',
    ...
    */
    ...
    //Altera a cor da faixa de cima da página (onde fica o logo da pagina)
    'skin' => 'blue',
    ...
    */
    ...
    //rota do dashboard (pode usar para parte adm do sistema)
    'dashboard_url' => 'home',
...
/*
        ...
        */
        ...
        //[
            //'text' => 'blog',
            //'url'  => 'admin/blog',
            //'can'  => 'manage-blog',//verifica permissão de acesso do profile
        //],
        [
            'text'        => 'Home',
            'url'         => 'home',
